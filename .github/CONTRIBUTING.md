...
- update the submodule in openeo-processes-dask
    ...
    - To specify the submodule explicitely, you can use
     `git submodule update --remote openeo_processes_dedl_slim/specs/openeo-processes/`
...
```
from openeo_processes_dedl_slim.specs import load_collection as load_collection_spec
