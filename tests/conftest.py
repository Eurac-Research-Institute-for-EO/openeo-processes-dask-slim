...
from openeo_processes_dedl_slim.process_implementations.data_model import VectorCube
...
def process_registry() -> ProcessRegistry:
    ...
    specs_module = importlib.import_module("openeo_processes_dedl_slim.specs")
